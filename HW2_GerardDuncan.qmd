...
-   Invalid #\_age #min-length #2widths
...
# a vector will be created by combining the statements with the first line, and the second and third demonstrates how strings can be put into the placements in that vector
```
...
#sep, separates the terms in a character string and collapse condences them into 1
...
#read.csv should do the trick? read.table is a secondary option
